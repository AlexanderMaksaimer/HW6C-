...
Console.Write(
    "Необходимо найти точку пересечения двух прямых,"+
    "\nзаданных уравнениями y = k1 * x + b1, y = k2 * x + b2;"+
    "\nзначения b1, k1, b2 и k2 вводятся с консоли.\n");
Console.WriteLine();

//Ввод по очереди всех необходимых переменных с консоли
int b1 = InputNumber("b1");
int k1 = InputNumber("уголовой коэф. k1");
int b2 = InputNumber("b2");
int k2 = InputNumber("уголовой коэф. k2");
